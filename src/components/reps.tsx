...
export const Reps = (props: RepsProps): JSX.Element => {
    return (
        ...
        <vstack backgroundColor='lightgray' cornerRadius="small" padding="small" width="100px" height="40px"><text size="medium" alignment='center middle' color="gray" onPress={props.onPress}>{props.target ?? ""}</text></vstack>
    )
}